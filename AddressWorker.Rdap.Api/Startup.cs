...
namespace AddressWorker.Rdap.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "AddressWorker.Rdap.Api", Version = "v1" });
            });

            services.AddSingleton(_ =>
            {
                RdapApiOptions rdapApiOptions = new();
                Configuration.Bind("RdapApiOptions", rdapApiOptions);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AddressWorker.Rdap.Api v1"));
            }
